...
- Keep `pyproject.toml` and `uv.lock` in the repository so the facilitator can reproduce the Python environment.
- The saved model was created with Python 3.12.13 and scikit-learn 1.6.1.
- Predictions are estimates based on the supplied dataset and should support, not replace, professional scouting decisions.
